# -*- coding: utf-8 -*-
{
    ...
    'version': '19.0.1.2.0',
    'summary': 'API REST (token firmado + res.users.apikeys) para la app móvil de Medicine Depot: auth, catálogo, sucursales, carrito/pedidos, perfil, direcciones e historial.',
    'description': (

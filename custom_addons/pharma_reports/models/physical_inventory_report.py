...
class ReportPhysicalInventoryDocument(models.AbstractModel):
    ...
    def _get_x_line_field_name(self):
        """Return the Studio field name linking product.template to x_line."""
        if 'x_line' not in self.env.registry.models:
            return False
    ...
    def _get_report_values(self, docids, data=None):
        ...
        line_field = self._get_x_line_field_name()

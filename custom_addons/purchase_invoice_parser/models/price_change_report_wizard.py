...
class PriceChangeReportWizard(models.TransientModel):
    ...
    def action_export_excel(self):
        ...
        for row, rec in enumerate(rows, start=1):
            ...
            ws.write(row, 2, rec['line_name'] or '', cell)

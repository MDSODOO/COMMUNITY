...
publicWidget.registry.ShopQtySelectorPage = publicWidget.Widget.extend({
    selector: "#products_grid, #products_grid_before",

    async start() {
        await this._super(...arguments);

        const badgeEls   = document.querySelectorAll(".js_sqty_stock");
        const widgetEls  = document.querySelectorAll(".js_shop_qty_selector");
        ...
        widgetEls.forEach((el) => {
            ...
            this._widgets.push(new ShopQtyWidget(el));
        });
    },
...
class ShopQtyWidget {
        ...
        this.el.innerHTML = `
            ...
            <div class="css_quantity input-group input-group-sm flex-nowrap align-items-stretch">
                ...
                <input type="number"
                       ...
                       value="0" min="0" max="${MAX_QTY}" step="1"
    ...
    _toggleButtons() {
        ...
        this.$plus.disabled  = this.qty >= MAX_QTY;
    }
